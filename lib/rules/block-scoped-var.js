...
module.exports = function(context) {
    ...
    function checkForVariables(node) {
        ...
        for (let i = 0; i < variables.length; ++i) {
            ...
            scopes.forEach(function walk(scope) {                               //eslint-disable-line no-loop-func, no-shadow
                for (let j = 0; j < scope.redeclarations.length; ++j) {         //eslint-disable-line no-shadow
