...
ruleTester.run("no-literal-call", rule, {
    ...
    invalid: [
        ...
        {code: "(class A {})();", env: {es6: true}, errors: ["This is not a function."]},
        ...
        {code: "new `hello`();", env: {es6: true}, errors: ["This is not a function."]},
        {code: "true``;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "false``;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "null``;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "100``;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "\"hello\"``;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "/abc/``;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "[1,2,3]``;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "({foo: 0})``;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "`hello```;", env: {es6: true}, errors: ["This is not a function."]},
        {code: "(class A {})``;", env: {es6: true}, errors: ["This is not a function."]},
    ],
})
